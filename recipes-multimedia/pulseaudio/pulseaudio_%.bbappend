...
# Set WM8524 (headphone jack) as default sink on i.MX8MM
do_install:append:imx8mm-nxp-bsp() {
    echo "" >> ${D}${sysconfdir}/pulse/default.pa
    echo "# Set WM8524 headphone as default output" >> ${D}${sysconfdir}/pulse/default.pa
    echo "set-default-sink alsa_output.platform-sound-wm8524.stereo-fallback" >> ${D}${sysconfdir}/pulse/default.pa
}
